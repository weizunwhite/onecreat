...
export const zh: Record<DictKey, string> = {
  ...
  "tool.do.write": "新建文件",
  "tool.do.edit": "修改代码",
  "tool.do.compile": "编译代码",
  "tool.do.upload": "烧录到开发板",
  "tool.do.monitor": "看串口输出",
  "tool.do.install": "安装依赖/工具",
  "tool.do.search": "搜索代码",
  "tool.do.list": "查看目录",
  "tool.do.web": "查网页",
  "tool.do.git": "Git 操作",
  "tool.do.bash": "运行命令",
  "tool.do.detectHw": "检测硬件",
  "tool.do.scaffold": "搭项目框架",
  "tool.do.hardware": "硬件操作",
  "tool.do.task": "派子任务",
  "tool.do.remember": "记笔记",
  "tool.do.findBoard": "查找开发板",
  "detail.simple": "简洁",
  "detail.detailed": "详细",
  "detail.toggleTitle": "切换简洁/详细显示。详细模式会显示原始命令和 AI 思考过程。",
