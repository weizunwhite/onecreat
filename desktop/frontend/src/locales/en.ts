...
export const en = {
  ...
  "tool.do.read": "Reading",
  "tool.do.write": "Creating file",
  "tool.do.edit": "Editing",
  "tool.do.compile": "Compiling",
  "tool.do.upload": "Flashing board",
  "tool.do.monitor": "Reading serial",
  "tool.do.install": "Installing",
  "tool.do.search": "Searching",
  "tool.do.list": "Listing",
  "tool.do.web": "Fetching",
  "tool.do.git": "Git",
  "tool.do.bash": "Running",
  "tool.do.detectHw": "Detecting hardware",
  "tool.do.scaffold": "Scaffolding",
  "tool.do.hardware": "Hardware",
  "tool.do.task": "Sub-task",
  "tool.do.remember": "Saving note",
  "tool.do.findBoard": "Finding board",
  "detail.simple": "Simple",
  "detail.detailed": "Detailed",
  "detail.toggleTitle": "Toggle simple/detailed view. Detailed shows raw commands and AI reasoning.",
