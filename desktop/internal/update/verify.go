...
// secrets (generated with `cmd/sign genkey`). Key ID CE54C025FD5BD466. If the
// signing key is ever rotated, regenerate and update this constant in lockstep
// with the CI secret.
const publicKey = `untrusted comment: minisign public key: CE54C025FD5BD466
RWRm1Fv9JcBUziTf1hy1qSHgmBXuw+peTtpJE9Kjsp+wRckrFDxkdZ9b`
